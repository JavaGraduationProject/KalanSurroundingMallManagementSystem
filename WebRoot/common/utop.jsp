    ...
    <div class="wrap">
        ...
        <div class="nav-bar">
            <ul>
                ...
                <li style="font-size:25px!important;"><a href="${ctx}/login/uIndex">首页</a></li>

                <li style="font-size:25px!important;"><a href="${ctx}/news/list">公告</a></li>

                <li style="font-size:25px!important;"><a href="${ctx}/message/add">留言</a></li>
