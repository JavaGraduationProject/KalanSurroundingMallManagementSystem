...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/resource/css/reset2.css">
...
<div class="header">
    <a href="#">
        <img src="${ctx}/resource/images/logo2.png" alt="ad">
    </a>
</div>
<%@include file="/common/ut1.jsp"%>
<!--导航条-->
<div class="width100" style="height: 45px;background: #333;margin-top: 40px;position: relative;z-index: 100;">
    <!--中间的部分-->
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        <!--列表导航-->
        <div class="left_yh Selected" style="width: 230px;height: 45px; background-color: #333;" id="hiddenShow">
            <!--头部的图标-->
            ...
            <!--导航展开部分-->
            <div class="downSlide" style=" background-color: rgba(105,101,101,0.6);">
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/shouye1.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/shouye2.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/shouye3.jpg" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
