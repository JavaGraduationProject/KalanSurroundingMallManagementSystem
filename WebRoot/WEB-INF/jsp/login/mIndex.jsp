...
<body style="background-color: #f2f9fd">
    <div class="header bg-main" style="background-color: #333333">
    ...
    <div class="leftnav">
        ...
        <ul style="display: block">
            ...
            <li><a href="${ctx}/itemCategory/tj" target="right"><span class="icon-caret-right"></span>销量管理</a> </li>
        </ul>
    </div>
    <ul class="bread">
    ...
    <div class="admin">
        <iframe scrolling="auto" rameborder="0" src="${ctx}/itemCategory/findBySql" name="right" width="100%" height="100%"></iframe>
    </div>
</body>
</html>