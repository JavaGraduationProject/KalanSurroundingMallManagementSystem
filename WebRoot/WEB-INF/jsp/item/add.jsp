...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form action="${ctx}/item/exAdd" method="post" class="form-x" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="label"><label>商品数量：</label></div>
                <div class="field">
                    <input type="text" class="input w50" name="pam2" data-validate="required:请输入商品数量" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <script type="text/javascript">
                        var editor = UE.getEditor('remark_txt_1');//UEditor插件，在文本框中提供了富文本编辑功能
