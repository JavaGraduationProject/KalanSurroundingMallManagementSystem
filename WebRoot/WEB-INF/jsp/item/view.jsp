...
<div class="width1198 center_yh" style="height: 420px;">
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        ...
        <p class="font16 c_66 likeColor" style="margin-top: 25px;">
            ...
            <font class="font14 c_99" style="margin-left: 20px;">库存：${obj.pam2}</font>
            <script>//数量加减
                var tr = $("#t_a").val();//val()获取原值
...
<script>
    ...
    $(function () {
    $(".addCar").click(function () {//通过class定位，加入购物车
        var id = $("#id").val();//商品id
        var num = $("#t_a").val();//购买数量
        $.ajax({
            type:"POST",
