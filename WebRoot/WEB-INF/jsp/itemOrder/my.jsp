...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/user/address" >个人地址</a>
        ...
        <div id="vipRight">
            <div style="width: 938px;border:1px solid #ddd;background: #fff;">
                <div class="width100 hidden_yh" style="height: 74px;line-height: 74px;background: #f5f8fa;border-bottom: 1px solid #ddd;" id="navLt">
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange slect">全部订单（${fn:length(all)}）</span>
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange">已取消（${fn:length(yqx)}）</span>
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange">待发货（${fn:length(dfh)}）</span>
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange">待收货（${fn:length(dsh)}）</span>
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange">已收货（${fn:length(ysh)}）</span>
                    <span class="left_yh font24 width16 tcenter cursor onHover onorange">已退款（${fn:length(ytk)}）</span>
                </div>
                <!--全部订单-->
                    ...
                    <c:forEach items="${all}" var="data" varStatus="l">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh fon20 c_66" style="background:#faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                ...
                                <c:if test="${data.status==4}">已退款</c:if>
                            </div>
                            <c:forEach items="${data.details}" var="chil" varStatus="l">
                               <a href="${ctx}/item/view?id=${chil.itemId}">
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="left_yh" style="width: 580px;">
                                        ...
                                        <c:if test="${data.status==2 or data.status==4 or data.status==3}"><h3 class="font18 c_33 font100">发货物流单号：${data.outTime}</h3></c:if>
                                        <c:if test="${data.status==4}"><h3 class="font18 c_33 font100">退货物流单号：${data.oMessage}</h3></c:if>
                        ...
                        <div class="width100 hidden_yh">
                            ...
                            <a href="${ctx}/item/view?id=${chil.itemId}">
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="left_yh" style="width: 580px;">
                                        <h3 class="font18 c_33 font100">${chil.item.name}</h3>
                                        <h3 class="font18 c_33 font100">发货物流单号：${data.outTime}</h3>
                                        <p class="c_66 font16" style="margin-top: 16px;">折扣：${chil.item.zk}</p>
                                        <p class="red" style="margin-top: 10px;">￥${chil.item.price}</p>
                                    </div>
                                    <div class="right_yh">
                                ...
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="right_yh">
                                        <c:if test="${data.status==3}">
                                            ...
                                            <a href="${ctx}/itemOrder/tk?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                                去退款
                                            </a>
                                        </c:if>
                                    </div>
                ...
                <!--已退款-->
                <div class="allGoods width100 hidden_yh hhD" style="display: none;">
                    <c:forEach items="${ytk}" var="data" varStatus="l">
                        <a href="${ctx}/item/view?id=${chil.itemId}">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh fon20 c_66" style="background:#faf5f5;text-indent: 47px;height: 50px;line-height: 50px;border-bottom: 1px solid #ddd;">
                                <fmt:formatDate value="${data.addTime}" type="both"/>&nbsp;&nbsp;订单号${data.code}&nbsp;&nbsp;
                            ...
                            <a href="${ctx}/item/view?id=${chil.itemId}">
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="left_yh" style="width: 580px;">
                                        <h3 class="font18 c_33 font100">${chil.item.name}</h3>
                                        <h3 class="font18 c_33 font100">发货物流单号：${data.outTime}</h3>
                                        <h3 class="font18 c_33 font100">退货物流单号：${data.oMessage}</h3>
                                        <p class="c_66 font16" style="margin-top: 16px;">折扣：${chil.item.zk}</p>
                                        <p class="red" style="margin-top: 10px;">￥${chil.item.price}</p>
                                    </div>
                                    <div class="right_yh">
...
<script type="text/javascript">
    $("#navLt span").click(function () {//点击事件
        var t = $(this).index();
